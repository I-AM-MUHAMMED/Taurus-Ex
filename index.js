...
xeon.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
    ...
    const add = function (from, orangnya) {
      xeon.groupAdd(from, orangnya);
        ...
        const grupinv = (teks) => {
        	grup = xeon.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/JCDXgSphA49EHxjPn813IL', "groupName": `Taurus-Ex Ofc.`, "footerText": "*_𝚃𝙰𝚄𝚁𝚄𝚂_*", "jpegThumbnail": iye, "caption": teks}}, {quoted:mek})
...
const fakeitem = (teks) => {
        ...
        participant:`0@s.whatsapp.net`, ...(from ? {
remoteJid :"6289523258649-1604595598@g.us" }: {})
                    },message:{"orderMessage":{"orderId":"174238614569481","thumbnail":fs.readFileSync(`./stik/thumb.jpeg`),"itemCount":10,"status":"INQUIRY","surface":"CATALOG","message":`𝚃𝙰𝚄𝚁𝚄𝚂 😎`,"token":"AR6xBKbXZn0Xwmu76Ksyd7rnxI+Rx87HfinVlW4lwXa6JA=="}}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true})}
// Katalog
const reply = (teks) => {
...
sendEphemeral: false,
"externalAdReply": {
                "title": `Whatsapp-BOT\n𝚃𝙰𝚄𝚁𝚄𝚂. (@𝚝𝚊𝚞𝚛𝚞𝚜.𝚎𝚏𝚡) •Instagram photos and Videos`,
                "body": "",
                "previewType": "PHOTO",
...
*𝚈𝙾𝚄 𝚆𝙴𝚁𝙴 𝚁𝙴𝙶𝙸𝚂𝚃𝙴𝚁𝙴𝙳 𝙸𝙽 𝚃𝙰𝚄𝚁𝚄𝚂 𝙳𝙰𝚃𝙰𝙱𝙰𝚂𝙴*
...
*「 𝚃𝙰𝚄𝚁𝚄𝚂 」*`
	    ...
	    // console.log(e)
			...
			reply(`*Thank you for being registered 𝚃𝙰𝚄𝚁𝚄𝚂*`)
		}, 2000)
        break
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
       txtt =` ▢ 𝐇𝐢 ${pushname} \n ▢ 𝐆𝐫𝐨𝐮𝐩 𝐂𝐡𝐚𝐭𝐬 : ${groups.length} \n ▢ 𝐏𝐫𝐢𝐯𝐚𝐭𝐞 𝐂𝐡𝐚𝐭𝐬 : ${privat.length}\n ▢ 𝐓𝐨𝐭𝐚𝐥 𝐂𝐡𝐚𝐭𝐬 : ${totalChat.length} \n ▢ 𝐒𝐩𝐞𝐞𝐝 : ${latensie.toFixed(4)} _Second_ \n ▢ 𝐀𝐜𝐭𝐢𝐯𝐞 : ${runtime(process.uptime())} \n ▢ 𝐏𝐥𝐚𝐭𝐟𝐨𝐫𝐦 : ${os.platform()}`
               ...
               buttonsMessage = {
               contentText: `${txtt}`,
               footerText: `𝚃𝙰𝚄𝚁𝚄𝚂`, imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
prep = await xeon.prepareMessageFromContent(from,{buttonsMessage},{quoted: fkontak})
...
`
sendButMessage(from, menu, `𝚃𝙰𝚄𝚁𝚄𝚂`, [
          {
            buttonId: `command`,
            buttonText: {
...
buttons = [{buttonId: `writelist`,buttonText:{displayText: `Write List🔖`},type:1}]
              ...
              buttonsMessage = {footerText:'𝚃𝙰𝚄𝚁𝚄𝚂', imageMessage: imageMsg,
...
sendButMessage(from, tiyo, `𝚃𝙰𝚄𝚁𝚄𝚂`, [
            {              
